...
#         else:
#             larger.append(x)
#         draw_list(draw_info,{x:draw_info.GREEN,pivot:draw_info.RED},True)
#         yield True

#     larger = quick_sort(larger, ascending=ascending)
#     smaller = quick_sort(smaller, ascending=ascending)

#     if ascending:
#         lst = list(smaller) + list(equal) + list(larger)

#     else:
#         lst = list(larger) + list(equal) + list(smaller)
